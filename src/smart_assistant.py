...
class SmartAssistant:
    ...
    def chatbot_response(self, user_prompt):
        messages = [
            {
                "role": "system",
        ...
        outputs = self.text_generation_pipeline(prompt, max_new_tokens=256, do_sample=True, temperature=0.7, top_k=50, top_p=0.95)
