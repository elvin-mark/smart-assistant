...
These are the services that are the "brain" of the smart assistant. There are in a separate [repository](https://github.com/elvin-mark/ai-server/tree/main).

## [Chatbot](https://github.com/elvin-mark/ai-server/tree/main/backbone/chatbot)
...
## [Embeddings](https://github.com/elvin-mark/ai-server/tree/main/backbone/embeddings)
...
## [Speech Recognition](https://github.com/elvin-mark/ai-server/tree/main/backbone/speech-recognition)
...
## [Text-to-Speech](https://github.com/elvin-mark/ai-server/tree/main/backbone/text-to-speech)
